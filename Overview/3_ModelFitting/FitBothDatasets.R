...
p.vector_A <- c(result$mle["p_1"], result$mle["p_2"], 1 - result$mle["p_1"] - result$mle["p_2"])
mu.vector_A <- c(result$mle["mu_1_gene_1"], result$mle["mu_2_gene_1"])
sigma_A <- result$mle["sigma"]
lambda_A <- result$mle["lambda"]
