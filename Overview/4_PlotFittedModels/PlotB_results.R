...
Pop123_B <- stochprofML::d.sum.of.mixtures.EXPLN((1:2000) / 100, n = 1, p.vector = p.vector_B, mu.vector = mu.vector_B, sigma = sigma_B, lambda = lambda_B, logdens = FALSE)
