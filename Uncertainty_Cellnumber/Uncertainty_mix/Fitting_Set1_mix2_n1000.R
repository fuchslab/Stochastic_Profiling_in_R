# Use Dataset 1 from Set 1 underlying big mix vector Simulate 1000 similar n
# vectors and estimate parameters

library(stochprofML)

geg_n2 <- c(rep(c(10, 15, 20, 50), 12), 10, 15)
...
# load dataset
Var_name <- paste("Set1", "mix2", sep = "_")
...
for (j in 1:n_rep) {
  ...
  save(result_fitting, file = "Fitting_mix2_n1000_complete.rda")
